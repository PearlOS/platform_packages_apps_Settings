...
public class PearlVersionDetailPreferenceController extends BasePreferenceController {
    ...
    public PearlVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_PEARL_VERSION_PROP,
                mContext.getString(R.string.unknown))  + " | " + SystemProperties.get(KEY_PEARL_BUILDTYPE_PROP, mContext.getString(R.string.unknown));
    }
